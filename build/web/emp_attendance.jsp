<%-- 
    Document   : emp_attendance
    Created on : Oct 6, 2018, 12:21:48 PM
    Author     : hp
--%>
            ...
            <div id="first">
                <div id="nav">
                    <ul>
                        ...
                        <li><a href="emp_attendance.jsp" class="active"><i class="fa fa-font iconwid" aria-hidden="true"></i>Attendance</a></li>
