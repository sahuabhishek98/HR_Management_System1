<%-- 
    Document   : grevance
    Created on : Oct 28, 2018, 6:59:42 PM
    Author     : hp
--%>
            ...
            <div id="first">
                <div id="nav">
                    <ul>
                        ...
                        <li><a href="grevance.jsp" class="active"><i class="fa fa-twitter iconwid" aria-hidden="true"></i>Grievance/Suggestion</a></li>
                ...
                <div id="work">
                    <center>
                        <form action="" >
                            <h1 style="font-size: 30px;">SUGGESTION/GRIEVANCE</h1><hr>
                            <textarea style="width: 75%;height:220px;font-size: 18px;" name="know"></textarea>
                            <br><br>
                            <input type="submit" name="sub" value="SUBMIT" id="botn" style="margin-right: 15px;" onclick="alert('your Suggestion Is Send To HR.THANNKS....')">
                            ...
                            <%
                                if (request.getParameter("sub") != null) {
                                    ...
                                    try {
                                        ...
                                        Class.forName("com.mysql.jdbc.Driver");
                                        con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hrmanage", "root", "");
                                        pst = con.prepareStatement("insert into sugg(userid,suggestion) values(?,?)");
                                        pst.setString(1, rs.getString(1));
                                        pst.setString(2, anc);
                                        x = pst.executeUpdate();
                                        if (x == 1) {
                                            response.sendRedirect("grevance.jsp");
                            %> 
                            <%
                                            }
